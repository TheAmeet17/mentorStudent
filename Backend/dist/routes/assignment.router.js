...
import { createAssignment, getAllAssignments, getAssignmentById, updateAssignment, deleteAssignment, assignToStudents, } from "../Controller/assignment.controller.js";
import { protect } from "../middleware/auth.middleware.js";
import { restrictTo } from "../middleware/role.middleware.js";
import { validate } from "../middleware/validate.middleware.js";
import { createAssignmentSchema, updateAssignmentSchema, assignToStudentsSchema, } from "../validators/assignment.validator.js";
const router = Router();
router.use(protect);
/**
 * @swagger
 ...
 */
router.post("/", restrictTo("mentor", "admin"), validate(createAssignmentSchema), createAssignment);
/**
 * @swagger
 * /api/assignments:
 *   get:
 ...
 *         description: Assignment not found
 */
router.put("/:id", restrictTo("mentor", "admin"), validate(updateAssignmentSchema), updateAssignment);
/**
 * @swagger
 * /api/assignments/{id}:
 *   delete:
