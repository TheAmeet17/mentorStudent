...
import { createStudent, getAllStudents, getStudentById, updateStudent, deleteStudent, getStudentProgress, } from "../Controller/student.controller.js";
 ...
 */
router.post("/", restrictTo("mentor", "admin"), validate(createStudentSchema), createStudent);
/**
 * @swagger
 * /api/students:
 *   get:
 ...
 *         description: Student not found
 */
router.put("/:id", restrictTo("mentor", "admin"), validate(updateStudentSchema), updateStudent);
/**
 * @swagger
 * /api/students/{id}:
 *   delete:
